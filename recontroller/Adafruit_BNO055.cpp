...
*/
/**************************************************************************/
Adafruit_BNO055::Adafruit_BNO055(int32_t sensorID, uint8_t address, TwoWire *twi)
{
  _sensorID = sensorID;
  _address = address;
  _twi = twi;
...
#ifdef ESP8266
  _twi->setClockStretchLimit(1000); // Allow for 1000us of clock stretching
#endif
...
byte Adafruit_BNO055::read8(adafruit_bno055_reg_t reg )
{
  ...
  #endif
  _twi->endTransmission();
  _twi->requestFrom(_address, (byte)1);
  #if ARDUINO >= 100
    value = _twi->read();
  #else
    value = _twi->receive();
...
bool Adafruit_BNO055::readLen(adafruit_bno055_reg_t reg, byte * buffer, uint8_t len)
{
  ...
  #endif
  _twi->endTransmission();
  _twi->requestFrom(_address, (byte)len);
